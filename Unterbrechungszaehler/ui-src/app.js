(() => {
  ...
  const I18N = {
    de: {
      ...
      'ota.unavailable': 'Das aktive Partitionsschema bietet keine zweite OTA-App-Partition. OTA ist damit nicht möglich.', 'ota.apWarning': 'Achtung: Der Fallback-AP ist offen. Solange er aktiv ist, kann jeder in WLAN-Reichweite diese Update-Seite erreichen.',
    ...
    en: {
      ...
      'ota.unavailable': 'The active partition scheme has no second OTA application partition, so OTA is unavailable.', 'ota.apWarning': 'Warning: the fallback AP is open. While it is active, anyone within Wi-Fi range can reach this update page.',
    ...
    swg: {
      ...
      'ota.unavailable': 'Des Partitionsschema hot koi zweite OTA-App-Partition. So goht OTA net.', 'ota.apWarning': 'Obacht: Dr Fallback-AP isch offen. Solang der läuft, kann jeder in WLAN-Reichweite auf d Update-Seite.',
  ...
  I18N.it = {
    ...
    "ota.unavailable": "Lo schema di partizionamento attivo non dispone di una seconda partizione applicativa OTA, quindi OTA non è disponibile.",
    "ota.apWarning": "Attenzione: l’AP di fallback è aperto. Finché è attivo, chiunque sia nel raggio Wi‑Fi può raggiungere questa pagina di aggiornamento.",
  ...
  I18N.fr = {
    ...
    "ota.unavailable": "Le schéma de partitions actif ne possède pas de seconde partition d’application OTA ; OTA est donc indisponible.",
    "ota.apWarning": "Attention : le point d’accès de secours est ouvert. Tant qu’il est actif, toute personne à portée Wi‑Fi peut accéder à cette page de mise à jour.",
  ...
  const state = {
    ...
    device: {}, wifi: {}, memory: {}, hardware: { checking: false, modules: [] }, ota: { supported: null, currentBytes: 0, maxBytes: 0, headroomBytes: 0 },
