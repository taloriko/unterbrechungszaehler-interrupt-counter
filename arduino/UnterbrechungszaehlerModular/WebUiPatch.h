...
function init(){addWeek();addBeta();addMeters();addBaseExportMeta();addArchiveExport();hookTheme();hookFetch();fastButton('addBtn',1,'/api/add');fastButton('undoBtn',-1,'/api/delete-last');setInterval(isoWeekFromDevice,1000)}
init();
})();
</script>
)HTML";
